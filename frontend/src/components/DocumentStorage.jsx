...
export default function DocumentStorage() {
    ...
    const fetchDocuments = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/fetch-documents', { userEmail });
    ...
    const handleDownload = async (docId) => {
        try {
            const response = await axios.get(`http://localhost:5000/download-document/${docId}`, {
                responseType: 'blob',
            });
    ...
    const handleDelete = async (docId) => {
        try {
            await axios.delete(`http://localhost:5000/delete-document/${docId}`);
